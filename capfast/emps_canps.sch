...
w 3972 1723 100 0 n#2 ecalcos.$(PS):CURDISABLE.FLNK 3832 1720 4112 1720 4112 1584 4272 1584 ecalcos.$(PS):CURTRIP.SLNK
w 4578 1811 100 0 n#3 ecalcos.$(PS):CURTRIP.FLNK 4560 1808 4596 1808 4596 1824 4640 1824 outhier.flink.p
w 4592 1779 100 0 n#4 ecalcos.$(PS):CURTRIP.VAL 4560 1776 4624 1776 4624 1736 4664 1736 outhier.statok.p
w 2712 1555 100 0 n#5 trcalcos.$(PS):STATUS.FLNK 1944 1552 3480 1552 3480 1496 3544 1496 ecalcos.$(PS):CURDISABLE.SLNK
w 986 1250 -100 0 n#6 inhier.scanin.P 976 1248 1136 1248 1136 1192 1184 1192 esels.$(PS):LOCKSEL.SLNK
w 1482 1442 -100 0 n#7 esels.$(PS):LOCKSEL.FLNK 1472 1432 1600 1432 1600 1328 1656 1328 trcalcos.$(PS):STATUS.SLNK
w 1474 1402 -100 0 n#8 esels.$(PS):LOCKSEL.VAL 1472 1400 1472 1552 1656 1552 trcalcos.$(PS):STATUS.INPF
...
p 3569 1095 100 0 1 SXST:Tune Lock
...
xform 0 1520 1392
use outhier 4631 1753 100 0 statok
xform 0 4648 1736
use ecalcos 4319 1484 100 0 $(PS):CURTRIP
xform 0 4416 1776
p 4263 1484 100 0 -1 PV:$(D)
p 4352 1936 150 0 1 CALC:A?(ABS(B-C)<(0.005*ABS(D-E))):F
p 4580 1737 100 0 0 def(OUT):
p 4356 1916 100 0 1 OCAL:0
p 4077 1932 100 0 1 def(INPB):$(PS):CUR
p 4352 1680 100 0 1 OOPT:On Change
p 4051 1897 100 0 1 def(INPC):$(PS):RDCUR
p 4019 1863 100 0 1 def(INPD):$(PS):CUR.DRVH
p 4026 1834 100 0 1 def(INPE):$(PS):CUR.DRVL
p 4011 1800 100 0 1 def(INPF):$(D)$(PS):STATUS
p 3969 1962 100 0 1 def(INPA):$(D)$(PS):CURDISABLE
p 4160 1872 100 0 0 def(FLNK):
p 4324 1620 100 0 0 SCAN:Passive
use ecalcos 3591 1396 100 0 $(PS):CURDISABLE
xform 0 3688 1688
p 3535 1396 100 0 -1 PV:$(D)
p 3629 1846 150 0 1 CALC:(A>2)&B
p 3852 1649 100 0 1 def(OUT):$(PS):CUR.DISP PP MS
p 3628 1828 100 0 1 OCAL:0
p 3275 1843 100 0 1 def(INPB):$(D)$(PS):STATUS
p 3624 1592 100 0 1 OOPT:On Change
p 3255 1813 100 0 0 def(INPC):
p 3251 1782 100 0 0 def(INPD):
p 3287 1744 100 0 0 def(INPE):
p 3298 1711 100 0 0 def(INPF):
p 3628 1564 100 0 0 DOPT:Use CALC
p 3267 1879 100 0 1 def(INPA):EMPS:BMPROPREQ
use esels 1238 1119 100 0 $(PS):LOCKSEL
xform 0 1328 1384
p 1182 1119 100 0 -1 PV:$(D)
p 1071 1570 100 0 1 def(INPA):0
p 1071 1538 100 0 1 def(INPB):6
p 873 1603 100 0 1 def(NVL):$(D)$(PS):CURDISABLE
