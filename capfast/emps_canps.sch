...
w 1484 1787 100 0 n#4 trcalcos.$(PS):STATUS.FLNK 1360 1784 1608 1784 1608 1512 1760 1512 ecalcos.$(PS):CURDISABLE.SLNK
w 2568 1499 100 0 n#5 ecalcos.$(PS):CUROK.FLNK 2552 1496 2584 1496 2584 1536 2632 1536 outhier.flink.p
w 2072 1739 100 0 n#6 ecalcos.$(PS):CURDISABLE.FLNK 2048 1736 2096 1736 2096 1272 2264 1272 ecalcos.$(PS):CUROK.SLNK
w 2124 1707 100 0 n#7 ecalcos.$(PS):CURDISABLE.VAL 2048 1704 2200 1704 2200 1656 2264 1656 ecalcos.$(PS):CUROK.INPA
w 1005 1496 100 0 n#2 junction 1000 1592 1000 1400 1656 1400 1656 1896 1760 1896 ecalcos.$(PS):CURDISABLE.INPA
...
s 1837 1811 100 0 Tune lock disables current setpoint when high-energy grant.
[cell use]
...
use ecalcos 1807 1412 100 0 $(PS):CURDISABLE
xform 0 1904 1704
p 1751 1412 100 0 -1 PV:$(D)
p 1840 1864 150 0 1 CALC:(A=1)&B&C
p 1853 1645 100 0 1 def(OUT):$(PS):CUR.DISP PP MS
p 1844 1844 100 0 1 OCAL:0
p 1544 1860 100 0 1 def(INPB):$(TUNELOCK)
p 1840 1608 100 0 1 OOPT:On Change
p 1519 1827 100 0 1 def(INPC):EMPS:TUNELOCK
p 1507 1791 100 0 0 def(INPD):
p 1514 1762 100 0 0 def(INPE):
p 1499 1728 100 0 0 def(INPF):
p 1619 1890 100 0 0 def(INPA):
p 1648 1800 100 0 -1 def(FLNK):
p 1812 1548 100 0 0 SCAN:Passive
[comments]
