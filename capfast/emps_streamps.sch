...
w 1932 1867 100 0 n#6 ecalcos.$(PS):DRVDISABLE.FLNK 1904 1864 1960 1864 1960 1552 2048 1552 ecalcos.$(PS):CURDISABLE.SLNK
w 2424 1747 100 0 n#7 ecalcos.$(PS):CURDISABLE.VAL 2336 1744 2512 1744 2512 1696 ecalcos.$(PS):CUROK.INPA
w 2404 1779 100 0 n#8 ecalcos.$(PS):CURDISABLE.FLNK 2336 1776 2472 1776 2472 1312 2512 1312 ecalcos.$(PS):CUROK.SLNK
...
w 1498 1442 -100 0 n#4 junction 1488 1432 2016 1432 2016 1904 2048 1904 ecalcos.$(PS):CURDISABLE.INPB
...
-AD
_
s 2125 1859 100 0 Tune lock disables current setpoint when high-energy grant.
...
use ecalcos 2095 1452 100 0 $(PS):CURDISABLE
xform 0 2192 1744
p 2039 1452 100 0 -1 PV:$(D)
p 2128 1904 150 0 1 CALC:A&(B=1)
p 2141 1685 100 0 1 def(OUT):$(PS):CUR.DISP PP MS
p 2132 1884 100 0 1 OCAL:0
p 1992 1899 100 0 0 def(INPB):
p 2128 1648 100 0 1 OOPT:On Change
p 1827 1865 100 0 0 def(INPC):
p 1795 1831 100 0 0 def(INPD):
p 1802 1802 100 0 0 def(INPE):
p 1787 1768 100 0 0 def(INPF):
p 1907 1930 100 0 1 def(INPA):$(TL)
p 1936 1840 100 0 -1 def(FLNK):
p 2100 1588 100 0 0 SCAN:Passive
